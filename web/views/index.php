...
<div class="row">
    ...
    <div class="col-md-4 <?php echo (strtotime($quiz['date_end']) < time())?'quizz-disabled':'';?>" style="padding:5px; box-shadow: 1px 1px 10px rgba(183, 87, 255, 0.5); border-radius:5px">
        <div style="background:#b757ff;">
            <img src="<?php echo $this->registry->fb->getLinkPhoto($quiz['img']);?>" alt="<?php echo htmlentities($quiz['name']);?>" style="display: block;margin-left: auto;margin-right: auto;padding-top:5px; height:100px">
